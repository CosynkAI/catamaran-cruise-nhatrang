const DEFAULTS = {
  url: 'https://cruisenhatrang.com',
  whatsapp: '84364389764',
  telegram: 'Nastasia8963',
  zaloPhone: '0364389764',
  zaloUrl: '',
...
export function getSiteConfig(env = {}) {
  ...
  const zaloUrl = read(env, 'VITE_ZALO_URL', DEFAULTS.zaloUrl);
  ...
  return {
    ...
    contacts: {
      ...
      zaloPhone: read(env, 'VITE_ZALO_PHONE', DEFAULTS.zaloPhone).replace(/\D/g, ''),
      zaloUrl,
