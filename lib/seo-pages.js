...
export const SEO_PAGES = [
  {
    ...
    locales: {
      ru: {
        title: 'Частный круиз в Нячанге | Private boat tour от $390',
        description:
          'Private boat tour Nha Trang: индивидуальный катамаран-круиз для вашей компании. Снорклинг, еда, бар и маршрут без толп. От $390.',
        ...
        heroLead:
          'Private boat tour для пар, семей и компаний — свой маршрут, бар, морепродукты и команда только для вас. От $390.',
      },
      en: {
        title: 'Private Cruise Nha Trang | Private Boat Tour from $390',
        description:
          'Private boat tour Nha Trang: charter a catamaran for your group only. Snorkeling, meals, open bar. From $390.',
        ...
        heroLead:
          'Private boat tour for couples, families and groups — custom route, open bar and crew just for you. From $390.',
      },
      ko: {
        title: '냐짱 프라이빗 크루즈 | Private boat tour $390부터',
        description: 'Nha Trang private boat tour: 단독 캐터마란, 스노클링, 식사, 바 포함. $390부터.',
        ...
        heroLead: '커플·가족·단체를 위한 private boat tour — $390부터, 맞춤 루트와 오픈 바.',
      },
      kk: {
        title: 'Нячангта жеке круиз | Private boat tour $390 бастап',
        description:
          'Private boat tour Nha Trang: жеке катамаран, снорклинг, тамақ, бар. Тек сіздің компанияңыз. $390 бастап.',
        ...
        heroLead: 'Жұптар, отбасылар және компанияларға private boat tour — $390 бастап.',
      },
    },
  },
  {
    ...
    locales: {
      ru: {
        title: 'Sunset cruise Нячанг | Закатный круиз на катамаране от $69',
        description:
          'Sunset cruise Nha Trang: закатный catamaran tour, музыка, еда и снорклинг. Групповой от $69, частный от $390.',
        ...
        heroLead:
          'Закатный catamaran tour: золотой час над морем, острова, снорклинг и ужин. Групповой от $69.',
      },
      en: {
        title: 'Sunset Cruise Nha Trang | Catamaran Sunset Tour from $69',
        description:
          'Sunset cruise Nha Trang: golden hour catamaran tour with islands, snorkeling and dinner. Group from $69.',
        ...
        heroLead: 'Golden-hour catamaran tour with islands, snorkeling and dinner. Group tours from $69.',
      },
      ko: {
        title: '냐짱 선셋 크루즈 | Sunset cruise $69부터',
        description: 'Sunset cruise Nha Trang: 캐터마란 선셋 투어, 스노클링, 식사. 단체 $69부터.',
        ...
        heroTitle: '냐짱 선셋&nbsp;크루즈',
        heroLead: 'Sunset cruise: 황금빛 바다, 섬과 스노클링. 단체 $69부터.',
      },
      kk: {
        title: 'Нячанг Sunset cruise | Закат круизі $69 бастап',
        description: 'Sunset cruise Nha Trang: закатты catamaran tour, снорклинг, кешкі ас. Топтық $69 бастап.',
        ...
        heroLead: 'Закатты catamaran tour — аралдар, снорклинг. Топтық $69 бастап.',
      },
    },
  },
  {
    ...
    locales: {
      ru: {
        title: 'Catamaran tour Нячанг | Морской тур на катамаране от $69',
        description:
          'Catamaran tour Nha Trang: групповые и частные морские туры, снорклинг, SUP, рыбалка. Yacht tour без толп. От $69.',
        ...
        heroLead:
          'Групповой и частный catamaran cruise: острова, снорклинг, SUP и обед в рыбацкой деревне. От $69.',
      },
      en: {
        title: 'Catamaran Tour Nha Trang | Boat Tour from $69',
        description:
          'Catamaran tour Nha Trang: group and private boat tours, snorkeling, SUP, fishing. From $69 per guest.',
        ...
        heroLead: 'Group and private catamaran cruise — islands, snorkeling, SUP and village lunch. From $69.',
      },
      ko: {
        title: '냐짱 캐터마란 투어 | Catamaran tour $69부터',
        description: 'Catamaran tour Nha Trang: 단체·프라이빗 보트 투어, 스노클링, SUP. $69부터.',
        ogTitle: '냐짱 캐터마란 투어',
        ...
        heroLead: 'Catamaran tour — 스노클링, SUP, 섬 투어. 단체 $69부터.',
      },
      kk: {
        title: 'Нячанг catamaran tour | Катамаран туры $69 бастап',
        description: 'Catamaran tour Nha Trang: топтық және жеке теңіз турлары, снорклинг, SUP. $69 бастап.',
        ...
        heroLead: 'Catamaran cruise — аралдар, снорклинг, SUP. Топтық $69 бастап.',
      },
    },
  },
  {
    ...
    locales: {
      ru: {
        title: 'Snorkeling tour Нячанг | Снорклинг на катамаране от $69',
        description:
          'Snorkeling tour Nha Trang: прозрачная вода Южных островов, catamaran cruise, обед и команда. От $69.',
        ...
        heroLead:
          'Snorkeling tour на катамаране: Южные острова, прозрачная вода, SUP и обед. Групповой от $69.',
      },
      en: {
        title: 'Snorkeling Tour Nha Trang | Catamaran Snorkel Trip from $69',
        description:
          'Snorkeling tour Nha Trang: Southern Islands, clear water, catamaran cruise and lunch. From $69.',
        ...
        heroLead: 'Catamaran snorkeling tour to the Southern Islands with lunch. Group tours from $69.',
      },
      ko: {
        title: '냐짱 스노클링 투어 | Snorkeling tour $69부터',
        description: 'Snorkeling tour Nha Trang: 남부 섬, 맑은 바다, 캐터마란 크루즈. $69부터.',
        ...
        heroLead: 'Snorkeling tour — 남부 섬, 맑은 물, 식사 포함. $69부터.',
      },
      kk: {
        title: 'Нячанг snorkeling tour | Снорклинг туры $69 бастап',
        description: 'Snorkeling tour Nha Trang: Оңтүстік аралдар, мөлдір су, катамаран. $69 бастап.',
        ...
        heroLead: 'Snorkeling tour — Оңтүстік аралдар, мөлдір су. Топтық $69 бастап.',
      },
    },
  },
  {
    ...
    locales: {
      ru: {
        title: 'День рождения на яхте Нячанг | Birthday on yacht от $900',
        description:
          'Birthday on yacht Nha Trang: VIP catamaran cruise с едой, баром, дрон-съёмкой и персональным маршрутом. От $900.',
        ...
        heroLead:
          'Birthday on yacht в Нячанге: VIP-круиз, премиальное меню, бар, дрон и маршрут под ваш праздник. От $900.',
      },
      en: {
        title: 'Birthday on Yacht Nha Trang | VIP Catamaran from $900',
        description:
          'Birthday on yacht Nha Trang: VIP catamaran cruise with premium food, open bar, drone video. From $900.',
        ...
        heroLead: 'VIP catamaran birthday — premium menu, open bar, drone video and custom route. From $900.',
      },
      ko: {
        title: '냐짱 요트 생일 파티 | Birthday on yacht $900부터',
        description: 'Birthday on yacht Nha Trang: VIP 캐터마란, 프리미엄 식사, 드론 촬영. $900부터.',
        ...
        heroTitle: '요트&nbsp;생일 파티',
        heroLead: 'Birthday on yacht — VIP 크루즈, 프리미엄 메뉴, 드론. $900부터.',
      },
      kk: {
        title: 'Нячангта яхтада туған күн | Birthday on yacht $900 бастап',
        description: 'Birthday on yacht Nha Trang: VIP катамаран, премиум тамақ, дрон түсірілімі. $900 бастап.',
        ogTitle: 'Нячангта катамаранда туған күн',
        ogDescription: 'Теңіздегі мереке — премиум сервис және закат.',
        schemaName: 'Nha Trang birthday catamaran cruise',
        schemaDescription: 'VIP birthday on yacht in Nha Trang.',
        heroTitle: 'Яхтада туған&nbsp;күн',
        heroLead: 'Birthday on yacht — VIP круиз, премиум меню, дрон. $900 бастап.',
      },
    },
  },
];
